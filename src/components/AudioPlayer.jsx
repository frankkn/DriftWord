...
// 唯讀的語音播放列（用於收到的陌生人回應）。
export default function AudioPlayer({ index, url, duration }) {
  ...
  return (
    <div className="flex items-center gap-4 py-3 border-b border-ink/10">
      ...
      <button
        ...
        className="w-10 h-10 shrink-0 rounded-full border border-ink/20 flex items-center justify-center text-ink-light active:bg-ink/5 disabled:opacity-30 transition-colors"
      >
